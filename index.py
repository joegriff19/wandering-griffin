...
def set_display_children(value):
    ...
    if value == 'Belfast':
        ...
        return ('I had a really great experience in Belfast and in Northern Ireland -- from an educational '
                ...
                html.Div(
                    dl.Map([dl.TileLayer(), dl.GeoJSON(data=coordinates.belfast_geojson)],
                           style={'height': '35vh', 'max-width': "400px", "margin": "auto"}, center=[25, -40], zoom=1)))
    ...
    if value == 'Kaunas':
        ...
        return ("I was really pleasantly surprised with Kaunas! The city is small and is primarily a single street, "
                ...
                "I'd definitely suggest you stay on this street or close by. "
                "Be sure to walk the entire street, from the Church of St. Michael the Archangel to the "
